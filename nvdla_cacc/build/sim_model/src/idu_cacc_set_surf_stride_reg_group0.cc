#include <cacc.h>
bool cacc::decode_cacc_cacc_set_surf_stride_reg_group0() {
auto local_var_1 = cacc_csb2cacc_addr.range(16, 0);
sc_biguint<17> local_var_2 = 36900;
...
auto& univ_var_9 = local_var_19;
return univ_var_9;
}
void cacc::update_cacc_cacc_set_surf_stride_reg_group0() {
auto cacc_csb2cacc_data_nxt_holder = cacc_csb2cacc_data;
cacc_group0_cacc_d_surf_stride = cacc_csb2cacc_data_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "cacc_set_surf_stride_reg_group0 state updates:" << std::endl;
instr_update_log << "    cacc_group0_cacc_d_surf_stride => " << std::hex << "0x" << cacc_group0_cacc_d_surf_stride << std::endl; 
