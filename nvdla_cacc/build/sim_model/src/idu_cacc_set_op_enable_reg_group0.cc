#include <cacc.h>
bool cacc::decode_cacc_cacc_set_op_enable_reg_group0() {
...
void cacc::update_cacc_cacc_set_op_enable_reg_group0() {
auto cacc_csb2cacc_data_nxt_holder = cacc_csb2cacc_data;
cacc_group0_cacc_d_op_enable = cacc_csb2cacc_data_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "cacc_set_op_enable_reg_group0 state updates:" << std::endl;
