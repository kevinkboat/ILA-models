#include <cacc.h>
bool cacc::decode_cacc_cacc_set_clip_cfg_reg_group1() {
auto local_var_1 = cacc_csb2cacc_addr.range(16, 0);
sc_biguint<17> local_var_2 = 36908;
...
auto& univ_var_22 = local_var_19;
return univ_var_22;
}
void cacc::update_cacc_cacc_set_clip_cfg_reg_group1() {
auto cacc_csb2cacc_data_nxt_holder = cacc_csb2cacc_data;
cacc_group1_cacc_d_clip_cfg = cacc_csb2cacc_data_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "cacc_set_clip_cfg_reg_group1 state updates:" << std::endl;
instr_update_log << "    cacc_group1_cacc_d_clip_cfg => " << std::hex << "0x" << cacc_group1_cacc_d_clip_cfg << std::endl; 
