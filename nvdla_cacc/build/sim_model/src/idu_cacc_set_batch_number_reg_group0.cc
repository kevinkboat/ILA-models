#include <cacc.h>
bool cacc::decode_cacc_cacc_set_batch_number_reg_group0() {
...
auto& univ_var_7 = local_var_19;
return univ_var_7;
}
void cacc::update_cacc_cacc_set_batch_number_reg_group0() {
auto cacc_csb2cacc_data_nxt_holder = cacc_csb2cacc_data;
cacc_group0_cacc_d_batch_number = cacc_csb2cacc_data_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "cacc_set_batch_number_reg_group0 state updates:" << std::endl;
instr_update_log << "    cacc_group0_cacc_d_batch_number => " << std::hex << "0x" << cacc_group0_cacc_d_batch_number << std::endl; 
