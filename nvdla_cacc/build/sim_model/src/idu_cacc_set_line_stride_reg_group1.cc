#include <cacc.h>
bool cacc::decode_cacc_cacc_set_line_stride_reg_group1() {
...
void cacc::update_cacc_cacc_set_line_stride_reg_group1() {
auto cacc_csb2cacc_data_nxt_holder = cacc_csb2cacc_data;
cacc_group1_cacc_d_line_stride = cacc_csb2cacc_data_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "cacc_set_line_stride_reg_group1 state updates:" << std::endl;
instr_update_log << "    cacc_group1_cacc_d_line_stride => " << std::hex << "0x" << cacc_group1_cacc_d_line_stride << std::endl; 
