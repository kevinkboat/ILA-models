#include <cacc.h>
bool cacc::decode_cacc_cacc_set_dataout_size_1_reg_group1() {
...
cacc_group1_cacc_d_dataout_size_1 = cacc_csb2cacc_data_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "cacc_set_dataout_size_1_reg_group1 state updates:" << std::endl;
instr_update_log << "    cacc_group1_cacc_d_dataout_size_1 => " << std::hex << "0x" << cacc_group1_cacc_d_dataout_size_1 << std::endl; 
