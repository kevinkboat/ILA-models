#include <cacc.h>
bool cacc::decode_cacc_cacc_set_out_saturation_reg_group1() {
auto local_var_1 = cacc_csb2cacc_addr.range(15, 0);
sc_biguint<16> local_var_2 = 36912;
...
auto& univ_var_23 = local_var_19;
return univ_var_23;
}
void cacc::update_cacc_cacc_set_out_saturation_reg_group1() {
auto cacc_csb2cacc_data_nxt_holder = cacc_csb2cacc_data;
cacc_group1_cacc_d_out_saturation = cacc_csb2cacc_data_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "cacc_set_out_saturation_reg_group1 state updates:" << std::endl;
