#include <cacc.h>
bool cacc::decode_cacc_cacc_set_dataout_size_0_reg_group0() {
...
auto& univ_var_4 = local_var_19;
return univ_var_4;
}
void cacc::update_cacc_cacc_set_dataout_size_0_reg_group0() {
auto cacc_csb2cacc_data_nxt_holder = cacc_csb2cacc_data;
cacc_group0_cacc_d_dataout_size_0 = cacc_csb2cacc_data_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "cacc_set_dataout_size_0_reg_group0 state updates:" << std::endl;
instr_update_log << "    cacc_group0_cacc_d_dataout_size_0 => " << std::hex << "0x" << cacc_group0_cacc_d_dataout_size_0 << std::endl; 
