#include <cmac.h>
bool cmac::decode_cmac_cmac_set_start_group0() {
...
void cmac::update_cmac_cmac_set_start_group0() {
auto local_var_1 = cmac_csb2cmac_data.range(0, 0);
auto local_var_1_nxt_holder = local_var_1;
cmac_group0_cmac_d_op_en = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "cmac_set_start_group0 state updates:" << std::endl;
