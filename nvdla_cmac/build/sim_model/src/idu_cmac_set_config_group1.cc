#include <cmac.h>
bool cmac::decode_cmac_cmac_set_config_group1() {
...
auto& univ_var_5 = local_var_23;
return univ_var_5;
}
void cmac::update_cmac_cmac_set_config_group1() {
auto local_var_1 = cmac_csb2cmac_data.range(31, 0);
auto local_var_1_nxt_holder = local_var_1;
cmac_group1_cmac_d_misc_cfg = local_var_1_nxt_holder;
#ifdef ILATOR_VERBOSE
instr_update_log << "No." << std::dec << GetInstrCntr() << '\t' << "cmac_set_config_group1 state updates:" << std::endl;
instr_update_log << "    cmac_group1_cmac_d_misc_cfg => " << std::hex << "0x" << cmac_group1_cmac_d_misc_cfg << std::endl; 
